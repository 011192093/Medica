...
<main id="main">
    <p><h1><p style="color:green">Emergency Helpline</h1></p><br>

    <form action="" method="post">
                   
                
                   <input type="text"  value= "Covid-19 telehealth "size=39 >
                   <input type="text"  value= "  09666777222"size=25><br>
                   <input type="text"  value= "National call center"size=39 >
                   <input type="text"  value= "  999-1"size=25><br>
                   <input type="text"  value= "Ministry of health"size=39 >
                   <input type="text"  value= "  16263"size=25><br>
                   <input type="text"  value= "General Health service "size=39 >
                   <input type="text"  value= "  333-1-2"size=25><br>
                   <input type="text"  value= "Covid-19 telehealth for Mother and Infant"size=39 >
                   <input type="text"  value= "  09666888888"size=25><br>
                   <input type="text"  value= "Community support heathline"size=39>
                   <input type="text"  value= "  09666777171"size=25><br>
               </form><br>
               <br>
